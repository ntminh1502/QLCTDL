    ...
    public partial class FrmBC3 : Form
    {
        ...
        private void btnHienThiBC3_Click(object sender, EventArgs e)
        {
            string sql = "SELECT TOP 5 d.MaTour, d.TenTour,d.MaCongTy,c.SoNguoiDKTour " +
                         "FROM tableDanhMucTour as d inner join(SELECT a.MaTour, SUM(b.b1) as SoNguoiDKTour " +
        ...
        private void btnInBC3_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT TOP 5 d.MaTour, d.TenTour,d.MaCongTy,c.SoNguoiDangKyTour " +
                         "FROM tableDanhMucTour as d inner join(SELECT a.MaTour, SUM(b.b1) as SoNguoiDangKyTour " +
                                                                "FROM tableLichTour as a inner join(SELECT MaLichTour, SUM(SoLuongDangKy) as b1 " +
                                                                                                    "FROM tableDangkyTour " +
                                                                                                     "GROUP BY MaLichTour) as b " +
                                                                "ON a.MaLichTour = b.MaLichTour " +
